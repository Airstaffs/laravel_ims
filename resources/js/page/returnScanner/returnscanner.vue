            ...
            <template #input-fields>
                ...
                <div class="input-group">
                    ...
                    <input type="text" v-model="serialNumber" placeholder="Enter Serial Number..."
                        ...
                        @keyup.enter="dualSerialProduct && showSecondSerialInput ? focusNextField('secondSerialInput') : (showManualInput ? focusNextField('locationInput') : processScan())"
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr v-for="(item, index) in returnHistory" :key="index">
                        ...
                        <td>
                            <span :class="'status-badge status-' + item.returnstatus">
                                {{ formatStatus(item.returnstatus) }}
                            </span>
                        </td>
                        <td>{{ item.BuyerName || item.costumer_name || 'Unknown' }}</td>
                        <td>
                    ...
                    <tr v-if="returnHistory.length === 0">
                        <td colspan="9" class="text-center">No return history found</td>
                    </tr>
                </tbody>
            </table>
        </div>
                ...
                <div v-for="(item, index) in returnHistory" :key="index" class="mobile-card">
                    <div class="mobile-card-header">
                        ...
                        <div class="mobile-return-info">
                            <h3 class="mobile-return-title">Return #{{ item.LPN || 'N/A' }}</h3>
                    ...
                    <div class="mobile-card-details">
                        ...
                        <div v-if="item.serialnumberb" class="mobile-detail-row">
                            ...
                            <span class="mobile-detail-value">{{ item.serialnumberb }}</span>
                        </div>
                        <div class="mobile-detail-row">
                            <span class="mobile-detail-label">Location:</span>
                            <span class="mobile-detail-value">{{ item.warehouselocation || 'Floor' }}</span>
                        </div>
                        <div class="mobile-detail-row">
                            <span class="mobile-detail-label">Status:</span>
                            <span :class="['mobile-detail-value', 'status-badge', 'status-' + item.returnstatus]">
                                {{ formatStatus(item.returnstatus) }}
                            </span>
                        </div>
                        <div class="mobile-detail-row">
