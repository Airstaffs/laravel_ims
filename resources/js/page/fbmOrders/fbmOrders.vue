                        ...
                        <tr :class="{ 'has-dispensed-items': hasDispensedItems(order) }">
                            ...
                            <td class="sticky-col second-sticky">
                                <ul class="list-unstyled product-details">
                                    <li>
                                        <p><strong>{{ order.platform_order_id }}</strong></p>
                                    </li>
                                    <li>
                                        <p><span>Customer name:</span> <span>{{ order.buyer_name || 'N/A' }}</span></p>
                                    </li>
                                    <li>
                                        <p><span>Address:</span> <span>{{ formatAddress(order.address) }}</span></p>
                                    </li>
                                    <li>
                                        <p><span>Fulfillment Channel:</span> <span
                                                class="fbm-tag">{{ order.FulfillmentChannel }}</span></p>
                                    </li>
                                    <li>
                                        <p><span>Amazon Order</span> <span>{{ formatDate(order.purchase_date) }}</span>
                                        </p>
                                    </li>
                                </ul>
                            </td>
                                ...
                                <div v-for="(item, itemIndex) in (order.items || [])" :key="itemIndex"
                                    ...
                                    <div class="product-title-row">
                                        <div class="checkbox-disabled-tooltip">
                                            ...
                                            <strong>{{ item.platform_title }}</strong>
                                        </div>
                                    ...
                                    <ul class="list-unstyled product-details m-0">
                                        <li>
                                            <p><strong>Order Item ID: </strong>
                                                {{ item.platform_order_item_id || 'N/A' }}
                                            </p>
                                        </li>
                                        <li>
                                            <p><strong>Ordered ASIN: </strong> {{ item.platform_asin }} <button
                                                    v-if="item.platform_asin" class="edit-small-btn">Edit</button></p>
                                        </li>
                                        <li>
                                            <p><strong>Ordered MSKU: </strong> {{ item.platform_sku }}</p>
                                        </li>
                                        <li>
                                            <p><strong>Ordered Condition: </strong> {{ item.condition }}</p>
                                        </li>
                                        <li>
                                            <p><strong>Item Price: </strong> $ ${{ parseFloat(item.unit_price ||
                                                0).toFixed(2) }}</p>
                                        </li>
                                        <li>
                                            <p><strong>Item Tax: </strong> $ ${{ parseFloat(item.unit_tax ||
                                                0).toFixed(2) }}</p>
                                        </li>
                                    </ul>

                                    <!-- Enhanced dispensed products display for multiple quantities -->
                                    <section v-if="isItemDispensed(item)" class="dispensed-item-details">
                                        <h3 class="dispensed-header m-0">
                                            <span>Dispensed Products ({{ getDispensedProductCount(item) }}/{{
                                                item.quantity_ordered }})</span>
                                        </h3>

                                        <hr class="dispensed-hr">
                                        ...
                                        <ul v-for="(dispensedProduct, dpIndex) in getDispensedProductsDisplay(item)"
                                            ...
                                            <li>
                                                <p><strong>Location: </strong>
                                                    {{ dispensedProduct.warehouseLocation || 'N/A' }}</p>
                                            </li>
                            ...
                            <td class="order-type-cell">
                                <ul class="list-unstyled orderType-details">
                                    <li>
                                        <p><strong>Order Type: </strong> {{ order.order_type || 'StandardOrder' }}</p>
                                    </li>
                                    <li>
                                        <p><strong>Shipment Service: </strong>
                                            {{ order.shipment_service || 'Standard' }}
                                        </p>
                                    </li>
                                    <li>
                                        <p><strong>Replacement Order: </strong>
                                            {{ order.is_replacement ? 'true' : 'false' }}
                                        </p>
                                    </li>
                                    <li>
                                        <p><strong>Shipped by Date: </strong> {{ formatShipByDate(order.ship_date) }}
                                        </p>
                                    </li>
                                    <li>
                                        <p><strong>Delivered by Date: </strong>
                                            {{ formatDeliveryDate(order.delivery_date) }}
                                        </p>
                                    </li>
                                    <li v-if="hasTrackingNumber(order)">
                                        <p><strong>Tracking Status: </strong> {{ getTrackingStatus(order) }}</p>
                                    </li>
                                </ul>
                            </td>
                            <!-- Order Status column -->
                            <td class="order-status-cell">
                                <ul class="list-unstyled orderStatus-details">
                                    <li>
                                        <p><strong>Purchase label date: </strong></p>
                                    </li>
                                    <li>
                                        <p>
                                    ...
                                    <li>
                                        <p><strong>Ship Status: </strong> {{ getShipStatus(order) }}</p>
                                    </li>
                                    <li>
                                        <p><strong>Store Name: </strong> {{ order.storename || 'N/A' }}</p>
                                    </li>
                                </ul>
                            </td>
                            <!-- Action column -->
