        ...
        async markProductNotFound(productId, item) {
            ...
            try {
                ...
                if (!orderId && item && item.outboundorderitemid) {
                    console.log(
                        "No order ID in context, searching in orders array..."
                    );
                    for (const order of this.orders) {
                        if (
                            ...
                            console.log(
                                "Found order ID from orders array:",
                                orderId
                            );
                            break;
                        }
