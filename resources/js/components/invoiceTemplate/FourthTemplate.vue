                ...
                <div class="invoice" ref="invoiceRef" v-if="currentSupplier">
                    ...
                    <div class="invoice-footer">
                        <div class="footer-left">
                            ...
                            <div class="footer-warranty">{{ warrantyFrom }} {{ warrantyFromUnitText }} – {{ warrantyTo }} {{ warrantyToUnitText }} Warranty Included</div>
                        </div>
...
.ch-bottom { display: flex; align-items: center; padding: 8px 24px; background: #e11d48; gap: 0; }
