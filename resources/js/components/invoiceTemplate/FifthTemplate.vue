                ...
                <div class="invoice" ref="invoiceRef" v-if="currentSupplier">
                    ...
                    <div class="company-header">
                        ...
                        <div class="ch-info">
                            ...
                            <div class="ch-warranty">{{ warrantyFrom }} {{ warrantyFromUnitText }} &mdash; {{ warrantyTo }} {{ warrantyToUnitText }} Warranty</div>
                    ...
                    <div class="invoice-footer">
                        <div class="footer-left">
                            ...
                            <div class="footer-warranty">{{ warrantyFrom }} {{ warrantyFromUnitText }} &mdash; {{ warrantyTo }} {{ warrantyToUnitText }} Warranty Included</div>
                        </div>
...
.ch-logo {
    width: 52px;
    height: auto;
    filter: brightness(0) saturate(100%) invert(21%) sepia(96%) saturate(1200%) hue-rotate(213deg);
}
