                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="printer-card-compact small-label-compact">
                                        ...
                                        <select class="form-select compact-printer-select" id="smallLabelPrinter" name="small_label_printer_id" required>
                                ...
                                <div class="col-md-6">
                                    <div class="printer-card-compact instruction-card-compact">
                                        ...
                                        <select class="form-select compact-printer-select" id="instructionCardPrinter" name="instruction_card_printer_id" required>
                            ...
                            <div class="row g-3">
                                <div class="col-md-8">
                                    ...
                                    <div class="compact-input-wrapper">
                                        <input type="text" class="form-control compact-input" id="marriageName" name="marriage_name"
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <label for="marriageDescription" class="compact-label">
                                        <i class="bi bi-card-text me-1"></i>Description <span class="text-muted">(Optional)</span>
                                    </label>
                                    <textarea class="form-control compact-input compact-textarea" id="marriageDescription" name="description" rows="2"
                        ...
                        <div class="compact-form-grid">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="compact-input-wrapper">
                                        <select class="form-select compact-input compact-select" id="editPrinterType" name="printer_type" required>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="compact-input-wrapper">
                                        <input type="text" class="form-control compact-input" id="editPrinterIP" name="ip_address"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="compact-input-wrapper">
                                        <input type="number" class="form-control compact-input" id="editPrinterPort" name="port"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="compact-input-wrapper">
                                        <select class="form-select compact-input compact-select" id="editPrinterStatus" name="status">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control compact-input compact-textarea" id="editPrinterDescription" name="description" rows="2"
                        ...
                        <div class="compact-form-grid">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="compact-input-wrapper">
                                        <select class="form-select compact-input compact-select" id="addPrinterType" name="printer_type" required>
                                            <option value="">Select Type</option>
                                            <option value="small_label">🏷️ Small Label</option>
                                            <option value="instruction_card">📋 Instruction Card</option>
                                        </select>
                            ...
                            <div class="row g-3">
                                <div class="col-md-8">
                                    ...
                                    <div class="compact-input-wrapper">
                                        <input type="text" class="form-control compact-input" id="addPrinterIP" name="ip_address"
                                               placeholder="192.168.1.100" required>
                                        <i class="bi bi-globe compact-input-icon"></i>
                                    </div>
                                    <div class="invalid-feedback compact-feedback">Valid IP required</div>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control compact-input compact-textarea" id="addPrinterDescription" name="description" rows="2"
                        ...
                        <div class="marriage-info-card">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <p class="mb-0 text-muted">Join two printers to work together seamlessly for synchronized printing operations.</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="printer-selection-card small-label-card">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <select class="form-select printer-select" id="smallLabelPrinter" name="small_label_printer_id" required>
                                ...
                                <div class="col-md-6">
                                    <div class="printer-selection-card instruction-card-card">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <select class="form-select printer-select" id="instructionCardPrinter" name="instruction_card_printer_id" required>
                        ...
                        <div class="marriage-details-section">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control marriage-input" id="marriageDescription" name="description" rows="3"
