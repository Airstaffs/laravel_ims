                    ...
                    .then(data => {
                        if (data.status === 'success') {
                            ...
                            if (JSON.stringify(lastPrivileges) !== JSON.stringify(privileges)) {
                                ...
                                document.getElementById('asinlist').checked = privileges.asinlist === 1;
                                document.getElementById('productionarea').checked = privileges.productionarea === 1;
                                document.getElementById('returnscanner').checked = privileges.returnscanner === 1;
                                document.getElementById('fbmorder').checked = privileges.fbmorder === 1;
                                document.getElementById('notfound').checked = privileges.notfound === 1;
                                document.getElementById('asinoption').checked = privileges.asinoption === 1;
                                document.getElementById('houseage').checked = privileges.houseage === 1;
                                document.getElementById('printer').checked = privileges.printer === 1;
