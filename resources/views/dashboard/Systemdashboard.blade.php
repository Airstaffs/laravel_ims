        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs" id="settingsTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="privileges-tab" data-bs-toggle="tab" data-bs-target="#privileges" type="button" role="tab" aria-controls="privileges" aria-selected="false">Privileges</button>
                    </li>
                </ul>
