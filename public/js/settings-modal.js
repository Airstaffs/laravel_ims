...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function initPrinterManagement() {
        ...
        const allPrintersTable = document.getElementById(
            "allPrintersTableBody"
        );
        if (!allPrintersTable) {
            console.error(
    ...
    function setupSubTabListeners() {
        ...
        const instructionCardTab = document.getElementById(
        ...
        const marriedPrinterTab = document.getElementById(
            "married-printer-tab"
        );
    ...
    function getTypeBadge(type) {
        const badges = {
            ...
            instruction_card:
                '<span class="badge bg-info">Instruction Card</span>',
        };
        return (
            badges[type] || '<span class="badge bg-secondary">Unknown</span>'
        );
    }
