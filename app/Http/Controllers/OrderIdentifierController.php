   ...
   protected function generateZPL(string $labelName, int $startNumber, int $endNumber, int $expectedCount): string
{
    $config = [
        ...
        'barcodeY'     => 20,      // Barcode Y position (adjusted for smaller label)
        'textY'        => 180,     // Text Y position (adjusted for smaller label)
        'barcodeH'     => 100,     // Barcode height (reduced for smaller label)
