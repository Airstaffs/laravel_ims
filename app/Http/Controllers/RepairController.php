...
class RepairController extends BasetablesController
{
    use TracksHistory;
    ...
    public function index(Request $request)
    {
        try {
            ...
            $location = $request->input('location', 'Repair');
            $includeImages = $request->boolean('include_images', false);

            Log::info('Repair API called', [
                'search' => $search,
                'location' => $location,
                'perPage' => $perPage,
            ...
            Log::info('Repair products fetched successfully', ['count' => $products->count()]);
    ...
    public function moveToCleaning(Request $request)
    {
        try {
            ...
            Log::info('Moving product from Repair to Cleaning', $validated);
            ...
            Log::error('Repair move-to-cleaning error', ['error' => $e->getMessage()]);
